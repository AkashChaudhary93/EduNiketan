...
export default function About() {
    return (
        <div className="bg-white">
            ...
            {/* About Hero */}
            <section className="relative pt-32 pb-20 lg:pt-44 lg:pb-40 mesh-gradient overflow-hidden">
            ...
            <section className="py-24 max-w-[1280px] mx-auto px-6">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    <div className="w-full lg:w-3/5 space-y-12">
                        <div>
                            <h2 className="text-4xl lg:text-5xl font-black text-gray-900 mb-6 tracking-tight text-balance">Enterprise Infrastructure for Modern India</h2>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-8 border-t border-gray-100">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h4 className="font-black text-gray-900 mb-1">Company Culture</h4>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h4 className="font-black text-gray-900 mb-1">Dual HQ Strategy</h4>
                    ...
                    <div className="w-full lg:w-2/5">
                        <div className="relative group hover:scale-[1.02] transition-transform duration-700">
                            ...
                            <img
                                ...
                                alt="Infrastructure"
                                className="relative w-full h-auto rounded-[3rem] shadow-2xl border border-gray-100 object-cover aspect-[4/3] grayscale group-hover:grayscale-0 transition-all duration-1000"
            ...
            <section className="py-24 bg-gray-50">
                <div className="max-w-[1280px] mx-auto px-6">
                    <div className="text-center mb-20">
                        <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-4 tracking-tight text-balance">Vision 2030</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {visions.map((v, i) => (
                            <motion.div
                                ...
                                whileHover={{ y: -10 }}
                            >
                                <SpotlightCard dark={false} className="h-full !p-10 !bg-white !border-gray-100 shadow-sm hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] transition-all duration-500 group">
                                    <div className="w-14 h-14 bg-gray-50 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300 group-hover:scale-110">
                                        {v.icon}
                                    </div>
                                    <p className="text-4xl font-black text-gray-900 mb-2">
                                        <Counter from={0} to={v.target} suffix={v.suffix} />
                                    </p>
            ...
            <section className="py-24 max-w-[1280px] mx-auto px-6">
                <div className="text-center mb-20">
                    <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-6 tracking-tight text-balance">Executive Leadership</h2>
                    <p className="text-lg text-gray-500 font-medium max-w-2xl mx-auto">The visionaries and architects building India's most secure education platform.</p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
                    {leaders.map((leader, i) => (
                        <div key={i} className="text-center group cursor-pointer">
                            <div className="relative w-full aspect-[4/5] rounded-[2.5rem] bg-gray-100 mb-6 overflow-hidden shadow-lg group-hover:shadow-2xl transition-all duration-500">
                                <img
                                    src={leader.img}
                                    alt={leader.name}
                                ...
                                />
                                <div className="absolute inset-0 bg-gradient-to-t from-[#0a1a2f] via-transparent to-transparent opacity-0 group-hover:opacity-60 transition-opacity duration-300" />
                            </div>
                            <h4 className="text-2xl font-black text-gray-900 mb-1 group-hover:text-blue-600 transition-colors">{leader.name}</h4>
                            <p className="text-blue-600 text-xs font-black uppercase tracking-widest mb-2">{leader.role}</p>
                            <p className="text-xs font-bold text-gray-400">{leader.dept}</p>
                        </div>
                    ))}
                </div>
            </section>
                ...
                <div className="max-w-[1280px] mx-auto px-6">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
                        <div className="max-w-xl text-center lg:text-left">
                            <h2 className="text-4xl lg:text-6xl font-black text-white mb-8 tracking-tighter">Dual-City Operations.</h2>
                            <p className="text-xl text-gray-400 font-medium mb-12">Tactically positioned to bridge the gap between policy making in UP and technical excellence in Chandigarh.</p>
                            <div className="flex flex-col sm:flex-row gap-6">
                                <div className="p-8 bg-white/5 border border-white/10 rounded-3xl flex-1 hover:bg-white/10 transition-colors">
                                    <MapPin className="w-8 h-8 text-blue-500 mb-6" />
                                    <h4 className="text-white text-xl font-bold mb-2">Varanasi, UP</h4>
                                    <p className="text-xs font-black text-gray-500 uppercase tracking-widest mb-4">Registered Headquarter</p>
                                ...
                                <div className="p-8 bg-white/5 border border-white/10 rounded-3xl flex-1 hover:bg-white/10 transition-colors">
                                    <MapPin className="w-8 h-8 text-cyan-500 mb-6" />
                                    <h4 className="text-white text-xl font-bold mb-2">Chandigarh</h4>
                                    <p className="text-xs font-black text-gray-500 uppercase tracking-widest mb-4">Operational Hub</p>
                                    <ul className="space-y-2 text-sm text-gray-400 font-medium">
                        ...
                        <div className="w-full lg:w-1/2 relative">
                            <Globe2 className="w-full h-auto text-blue-500/10 animate-pulse-slow" />
